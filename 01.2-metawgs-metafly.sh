...
#SBATCH --job-name=metagWGS_2
#SBATCH --output=/data/users/fkurz/metagenomics/output/output-WGS2/output_metagWGS_%j.o
#SBATCH --error=/data/users/fkurz/metagenomics/output/output-WGS2/error_metagWGS_%j.e
...
OUTBASE="/data/users/fkurz/metagenomics/output/metagWGS-metafly"
